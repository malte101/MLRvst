...
echo ""
echo "To install to system plugin folders, run:"
echo "  scripts/install_macos_plugins.sh --system"
echo ""
echo "To install to user plugin folders, run:"
echo "  scripts/install_macos_plugins.sh --user"
echo ""
